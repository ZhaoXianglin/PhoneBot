  ...
  data: function () {
    return {
      ...
      q1group: [
        ...
        {q: "I could control the recommendations the chatbot made for me.", t: "control4"},
        {q: "The chatbot cared about me.", t: "cui_positive2"},
        {q: "I understood how well the recommendations matched my preferences.", t: "trans3"},
        {q: "I felt in control of telling the chatbot what I wanted.", t: "control5"},
        ...
        {q: "I was satisfied with the recommendations made by the chatbot.", t: "satis1"},
        {q: " I was confident I would like the phones recommended to me.", t: "confidence2"},
        {q: "The recommendations made by the chatbot were satisfying.", t: "satis2"},
        {q: "I had confidence in accepting the phones recommended to me.", t: "confidence4"},
        {q: " These recommendations made by the chatbot made me satisfied.", t: "satis3"},
